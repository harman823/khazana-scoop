...
function StoreHeader() {
  ...
  return <>
    ...
    <header className="commerce-header">
      ...
      <Link className="commerce-brand" to="/"><img src="/assets/logo.png" alt="Khazana Scoop Logo" style={{ height: "24px", width: "24px", borderRadius: "6px", objectFit: "cover", marginRight: "8px" }} /><strong>KhazanaScoop</strong></Link>
...
function StoreFooter() {
  return <footer className="commerce-footer">
    <div><Link className="commerce-brand" to="/"><img src="/assets/logo.png" alt="Khazana Scoop Logo" style={{ height: "24px", width: "24px", borderRadius: "6px", objectFit: "cover", marginRight: "8px" }} /><strong>KhazanaScoop</strong></Link><p>Cute finds, mystery scoops and thoughtful little gifts, packed in India.</p></div>
