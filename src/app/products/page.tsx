...
const heroProduct = featuredProducts.find((product) => product.slug === "mystery-scoops") ?? featuredProducts[0]!;
const secondaryProducts = featuredProducts.slice(1, 3);
const catalogProducts = featuredProducts.slice(3);
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Link className="button-primary focus-ring" href={heroProduct.route}>
                  Shop mystery scoops <Sparkles size={17} />
                </Link>
