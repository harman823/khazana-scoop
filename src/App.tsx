    ...
    <>
      ...
      {isLoading ? <main><LoadingScreen label="Loading KhazanaScoop" /></main> : <main>
        ...
        <section className="section scoop-shortcuts">
          <div className="section-heading"><h2>Scoop options live in the shop</h2></div>
